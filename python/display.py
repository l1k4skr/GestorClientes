...
class Product:
    def __init__(self, window):
        ...
        self.db = databaseconn.DatabaseConnection('localhost', username, passw, 'lawyerdb')
        ...
        self.name.grid(row = 0, column = 1, padx = 10, pady = 5, sticky = W + E)
        ...
        # Button Add Client
        ttk.Button(frame, text = "Save client", command=self.send).grid(row = 4, columnspan = 2, sticky = W + E)
